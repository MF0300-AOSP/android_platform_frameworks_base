...
final class Session implements RemoteFillService.FillServiceCallbacks, ViewState.Listener,
    ...
    Session(@NonNull AutofillManagerServiceImpl service, @NonNull AutoFillUI ui,
        ...
        mMetricsLogger.action(MetricsEvent.AUTOFILL_SESSION_STARTED, mComponentName.getPackageName());
    }
    ...
    void setAuthenticationResultLocked(Bundle data, int authenticationId) {
        ...
        if (result instanceof FillResponse) {
            ...
            mMetricsLogger.action(MetricsEvent.AUTOFILL_AUTHENTICATED, mComponentName.getPackageName());
    ...
    public boolean showSaveLocked() {
        ...
        if (allRequiredAreNotEmpty) {
            ...
            if (atLeastOneChanged) {
                ...
                getUiForShowing().showSaveUi(mService.getServiceLabel(), saveInfo, mComponentName.getPackageName(),
                        this);
                mIsSaving = true;
                return false;
            }
    ...
    RemoteFillService destroyLocked() {
        ...
        mDestroyed = true;
        mMetricsLogger.action(MetricsEvent.AUTOFILL_SESSION_FINISHED, mComponentName.getPackageName());
    ...
    private LogMaker newLogMaker(int category) {
        return newLogMaker(category, mService.getPackageName());
    }
